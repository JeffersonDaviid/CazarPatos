...
import com.chileno.jefferson.cazarpatos.Player
...
class RankingPlayerDBHelper(context: Context) : SQLiteOpenHelper(
    ...
    companion object {
        ...
        private const val SQL_CREATE_ENTRIES =
            "CREATE TABLE ${TABLE_NAME} (" + "${BaseColumns._ID} INTEGER PRIMARY KEY," + "${COLUMN_NAME_PLAYER} TEXT," + "${COLUMN_NAME_DUCKS} INTEGER)"
    ...
    fun insertRankingByQuery(player: Player) {
        ...
        // Create a new map of values, where column names are the keys
        val sqlSentence =
            "INSERT INTO ${TABLE_NAME} " + "(${COLUMN_NAME_PLAYER}, ${COLUMN_NAME_DUCKS}) " + "VALUES('${player.username}',${player.huntedDucks})"

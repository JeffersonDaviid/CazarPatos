...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_main)/*ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main))
        { v, insets ->
        val systemBars =
...
// Generamos 2 números aleatorios, para la coordenadas x , y
        ...
        imageViewDuck.animate().x(randomX.toFloat()).y(randomY.toFloat())
